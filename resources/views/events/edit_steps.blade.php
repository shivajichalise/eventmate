                        ...
                        <div class="stepwizard">
                            <div class="stepwizard-row setup-panel">
                                ...
                                <div class="stepwizard-step {{ $step >= 1 ? 'active' : '' }}">
                                    <a href="{{ route('events.edit.form', ['event' => $general, 'step' => 'general']) }}" type="button" class="btn btn-primary btn-circle">
                                ...
                                <div class="stepwizard-step {{ $step >= 2 ? 'active' : '' }}">
                                    <a href="{{ route('events.edit.form', ['event' => $general, 'step' => 'sub-events']) }}" type="button" class="btn btn-primary btn-circle">
                                ...
                                <div class="stepwizard-step {{ $step >= 3 ? 'active' : '' }}">
                                    <a href="{{ route('events.edit.form', ['event' => $general, 'step' => 'tickets']) }}" type="button" class="btn btn-primary btn-circle">
                                ...
                                <div class="stepwizard-step {{ $step >= 4 ? 'active' : '' }}">
                                    <a href="{{ route('events.edit.form', ['event' => $general, 'step' => 'support']) }}" type="button" class="btn btn-primary btn-circle">
